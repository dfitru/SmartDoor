    ...
    public partial class FirstMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.KeyOwner", t => t.KeyOwnerId)
                .ForeignKey("dbo.Door", t => t.DoorId)
                .Index(t => t.KeyOwnerId)
                .Index(t => t.DoorId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        KeyOwenerId = c.Int(nullable: false, identity: true),
                        FirstName = c.String(nullable: false, maxLength: 100),
                        LastName = c.String(nullable: false, maxLength: 100),
                        Company = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.KeyOwenerId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SmartKey", "KeyOwnerId", "dbo.KeyOwner");
            ...
            DropIndex("dbo.SmartKey", new[] { "KeyOwnerId" });
